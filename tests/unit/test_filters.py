"""Unit tests for filters.py - QueryFilter.matches() + edge cases."""

from linkora.filters import QueryFilter


class TestQueryFilter:
    """Tests for QueryFilter.matches()."""
    ...
    def test_year_less_than(self):
        """Year < N filter."""
        f = QueryFilter(year="<2025")
        assert f.matches({"year": 2024}) is True
        assert f.matches({"year": 2025}) is False

    def test_year_range(self):
        """Year range filter."""
        f = QueryFilter(year="2020-2024")
    ...
    def test_paper_type_exact(self):
        ...
        f = QueryFilter(paper_type="article")
    ...
    def test_combined_filters(self):
        ...
        f = QueryFilter(year=">2020", journal="nature")
    ...
    def test_combined_edge_cases(self):
        ...
        f = QueryFilter(year=">2020", journal="nature", author="smith")
